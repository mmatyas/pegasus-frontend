...
INCLUDEPATH += $${TOP_SRCDIR}/src/backend $${TOP_SRCDIR}/src/thirdparty $${TOP_SRCDIR}/thirdparty
DEPENDPATH += $${TOP_SRCDIR}/src/backend $${TOP_SRCDIR}/src/thirdparty $${TOP_SRCDIR}/thirdparty
