...
GamepadButtonNavigation::GamepadButtonNavigation(QObject* parent)
    ...
    , m_timers {
        ...
        { GamepadButton::A, new QTimer(this) },
        { GamepadButton::B, new QTimer(this) },
        { GamepadButton::C, new QTimer(this) },
        { GamepadButton::X, new QTimer(this) },
        { GamepadButton::Y, new QTimer(this) },
        { GamepadButton::Z, new QTimer(this) },
    ...
    , m_keys {
        ...
        { GamepadButton::A, static_cast<Qt::Key>(GamepadKeyId::A) },
        { GamepadButton::B, static_cast<Qt::Key>(GamepadKeyId::B) },
        { GamepadButton::C, static_cast<Qt::Key>(GamepadKeyId::C) },
        { GamepadButton::X, static_cast<Qt::Key>(GamepadKeyId::X) },
        { GamepadButton::Y, static_cast<Qt::Key>(GamepadKeyId::Y) },
        { GamepadButton::Z, static_cast<Qt::Key>(GamepadKeyId::Z) },
