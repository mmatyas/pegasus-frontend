...
{
    model::Game game("test");
    game.addFile(new model::GameFile(QFileInfo("test1"), this))
        .addFile(new model::GameFile(QFileInfo("test2"), this))
        .finalize();
...
{
    model::Game game("test");
    game.addFile(new model::GameFile(QFileInfo("test"), this)).finalize();
